...
ZSTD_LIB_ARGS = -j lib-nomt UNAME=Windows ZSTD_LIB_COMPRESSION=0 ZSTD_LIB_DICTBUILDER=0 AR="zig ar"
...
llrt-windows-x64.zip: | clean-js js
	cargo $(BUILD_ARG) --target $(TARGET_windows_x86_64)
	zip -j $@ target/$(TARGET_windows_x86_64)/release/llrt
